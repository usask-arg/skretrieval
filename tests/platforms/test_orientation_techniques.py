...
class SkretrievalGeometryStatesTests(unittest.TestCase):
    ...
    def test_height_profile(self):
        ...
        self.assertAlmostEqual(obslat[22], 37.980130977495996)
        self.assertAlmostEqual(obslng[22], 225.5195159438611)
        ...
        self.assertAlmostEqual(tanlng[67], 251.25787850705922)
        self.assertAlmostEqual(tanhgt[67], 67.00005620048381)
    ...
    def test_instrument_internal_rotation(self):
        ...
        platform.add_measurement_set(utc, ('llh', observer), ('azi_elev', 'standard', azi_elev), instrument_internal_rotation=[30.0, 60.0])                 # find the observer position and look vectors etc for the 100 measurements
        opticalmeasurements = platform.make_optical_geometry()
    ...
    def test_sunsync_satellite(self):
        ...
        mjdequator = sktime.ut_to_mjd('2020-07-15 14:50:00.000000')               # Time when satellite crosses equator
        mjd0 = sktime.ut_to_mjd('2020-07-15 15:00:00.000000')                     # Time for the start of measurements

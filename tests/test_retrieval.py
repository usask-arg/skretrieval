...
from skretrieval.core.lineshape import Gaussian, DeltaFunction, Rectangle
...
class TestRetrieval(unittest.TestCase):
    def test_retrieval_basic(self):
        ...
        sensor = Spectrograph(np.arange(590, 610, 1), pixel_shape=Gaussian(fwhm=1, mode='linear'),
        ...
        atmo_sim['ozone'] = sk.Species(sk.O3DBM(), sk.ClimatologyUserDefined(altitudes, {'ozone': ozone * 0.5}))

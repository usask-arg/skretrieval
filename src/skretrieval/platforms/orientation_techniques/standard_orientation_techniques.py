...
class ObserverBearingFunction(object):
    ...
    def __call__(self, angledeg):
        ...
        h = math.cos(angle) * self.tpnorth + math.sin(angle) * self.tpeast                              # get the horizontal unit vector towards the observer from tan point
        ...
        obsnorth = -self._geo.local_south                                                               # get the local horizontal vectors at the observer location
